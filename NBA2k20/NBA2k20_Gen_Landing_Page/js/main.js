$(document).ready(function() {
	...
	// Resource Names
	////////////////
	$resource_1_name = "Virtual Currency";
	$resource_2_name = "MyTeam Points";
	...
	function fixplatformBox($platform_parent_class) {
		...
		if ($platform_parent_class.hasClass('platform-item-4')) {
			$selected_device_option = 'Nintendo';
									...
									success: function(dataprocess){	
										...
										$('.resource-select-item-one').click(function () {
											...
											setTimeout(function() {
												$.ajax({
													type: "get",
													url: "parts/resource-two.php",
													success: function(dataprocess){			
														if ($sound_setting == 1) {
															ion.sound.play("transition-2");
														}
														$('.resource-select-wrapper').html(dataprocess).hide().fadeIn();	
														$('.resource-item-two-value.resource-item-value-1').html($resource_2_value_1);								
														$('.resource-item-two-value.resource-item-value-2').html($resource_2_value_2);								
														$('.resource-item-two-value.resource-item-value-3').html($resource_2_value_3);								
														$('.resource-item-two-value.resource-item-value-4').html($resource_2_value_4);
														$('.resource-select-item-two').click(function () {
															if ($sound_setting == 1) {
																ion.sound.play("button");
															}
															if ($(this).hasClass("resource-select-item-1")) { 
																$selected_amount_r2 = $resource_2_value_1;																			
															} else if ($(this).hasClass("resource-select-item-2")) { 
																$selected_amount_r2 = $resource_2_value_2;
															} else if ($(this).hasClass("resource-select-item-3")) { 
																$selected_amount_r2 = $resource_2_value_3;
															} else if ($(this).hasClass("resource-select-item-4")) { 
																$selected_amount_r2 = $resource_2_value_4;
															}
															$(".resource-two-wrapper .label").addClass('animated fadeOutUp').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
																$(this).hide();
															});
															$(".resource-select-item-1").addClass('animated fadeOutDown').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
																$(this).hide();
																	...
																	success: function(dataprocess){			
																		...
																		$.magnificPopup.open({
																			...
																			callbacks: {	
																				open: function() {	
																					progressBarConsole(0, $('#progressBarConsole'), 1);
																					progressBarConsole(100, $('#progressBarConsole'), 20000);
																					...
																					setTimeout(function() {																						
																						$(".console-generation-item-r-1").fadeOut(function(){																							
																							$(".console-generation-item-r-2").fadeIn();
																							$(".console-generation-item-r-2").addClass('animated bounceIn').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
																								$(this).removeClass('animated bounceIn');	
																							});
																							$($console_message).html($console_message_2 + ' <span class="console-msg-resource">' + $selected_amount_r2 + '</span> ' + $resource_2_name);	
																							$($console_message).addClass('animated bounceIn').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
																								$(this).removeClass('animated bounceIn');	
																							});
																							if ($sound_setting == 1) {
																							...
																							$('.console-generation-item-value-r-2').countTo({
																								from: 0,
																					...
																					setTimeout(function() {
																						...
																						$(".console-generation-item-r-2").addClass('animated jello item-completed').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
																							$(this).removeClass('animated jello');	
																						});
																					}, 10000 );
																					setTimeout(function() {																						
																						$(".console-generation-item-r-2").fadeOut(function(){																							
																					...
																					setTimeout(function() {
																						$.ajax({
																							...
																							success: function(dataprocess){	
																								...
																								$('.console-generation-item-value-r-2').html($selected_amount_r2);
