...
Landing page shared by CPALanding.com
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		<title>Mario Kart Tour Online Generator</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
		<meta name="description" content="Mario Kart Tour Online Generator" />    
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<link rel="icon" type="image/ico" href="img/favicon.ico" />
		<!-- Open Graph Meta Tags-->
		<meta property="og:title" content="Mario Kart Tour Online Generator" /> <!-- Title which is displayed when your site is shared on social networks -->
		<meta property="og:description" content="Mario Kart Tour Online Generator" /> <!-- Website description which is displayed when your site is shared on social networks -->
		...
		<div class="main-wrapper">			
				<header>					
					<div class="branding-wrapper">						
						<img src="img/logo.png" class="img-fluid logo-img" alt="Mario Kart Tour" />
					</div>
				</header>
						...
						<div class="generator-wrapper">
							...
							<div class="generator-content">								
								<div class="form-wrapper">
									<div class="label animated bounceIn animation-delay-400">User ID and Device</div>
									...
									<div class="button-wrapper animated bounceIn animation-delay-1000">
										<div id="proc-btn-1" class="mkt-btn">
											<span>Connect</span>
										</div>
									</div>
								</div>
